...
import numpy as np
#Read XML file
face_cascade = cv2.CascadeClassifier('ml/haarcascade_frontalface_default.xml')
#create video capture object. 0 denotes webcam
#cap=cv2.VideoCapture(0)
def detect_beard(file_path):
...
#print(detect_beard('Sample_output-2.png'))